...
public class SelectPrepareStatementQueryTestOrderDouble {
    ...
    public void test() {
        ...
        condition.asc(Student::getCreateAt);
        ...
        String target = "SELECT id, nickname, age, update_at, create_at FROM tbl_student WHERE nickname LIKE ? AND age IN (1,2,3) AND create_at > ? ORDER BY age DESC, create_at ASC LIMIT 0,20";
