...
public class SelectPrepareStatementTestOrderDouble {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SelectPrepareStatementTestOrderDouble.class);
    ...
    public void test() {
        ...
        String target = "SELECT id, nickname, age, update_at, create_at FROM tbl_student WHERE age IN ? AND create_at > ? AND nickname LIKE ? ORDER BY age DESC, create_at ASC LIMIT 0,20";
